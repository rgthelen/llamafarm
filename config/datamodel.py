...
#   timestamp: 2025-08-20T14:50:44+00:00
...
class Section(BaseModel):
    ...
    content: list[str] = Field(..., description="List of section content")


class Prompt(BaseModel):
    name: str = Field(..., description="Prompt name")
    sections: Optional[list[Section]] = Field(None, description="List of prompt sections")
    raw_text: Optional[str] = Field(None, description="Raw text of the prompt")
