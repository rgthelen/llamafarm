...
<div align="center">
  ...
  **Empowering developers to build production-ready AI applications with complete local control**
  ...
  [![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/llama-farm/llamafarm/blob/main/CONTRIBUTING.md)
...
### Component Guides
- 📖 [RAG System Guide](./rag) - Document processing and retrieval
- 🤖 [Models Guide](./models) - Model management and providers
- 📝 [Prompts Guide](./prompts) - Prompt engineering and templates
...
<div align="center">
  <img src="/img/iron-workers-llama.png" alt="Iron Worker Llamas" width="400"/>
...
See our [Contributing Guide](https://github.com/llama-farm/llamafarm/blob/main/CONTRIBUTING.md) for more details.
...
See [CREDITS.md](https://github.com/llama-farm/llamafarm/blob/main/CREDITS.md) for a complete list.

---

## 📄 License

LlamaFarm is MIT licensed. See [LICENSE](https://github.com/llama-farm/llamafarm/blob/main/LICENSE) for details.
