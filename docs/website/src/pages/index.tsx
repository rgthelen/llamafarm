      ...
      <div className="container">
        <div className={styles.heroContent}>
          ...
          <p className={styles.heroDescription}>
            The open-source framework for building, managing, and deploying AI applications 
            with any model, on any cloud, anywhere. Take control of your AI infrastructure 
            with simple YAML configurations.
          </p>
      ...
      <div className="container">
        ...
        <div className={styles.whyGrid}>
          <div className={styles.whyCard}>
            <h3>🏠 Local First</h3>
            <p>
              Run AI models locally on your hardware. No cloud dependency, no data leaving 
              your infrastructure. Complete privacy and control.
            </p>
          </div>
          <div className={styles.whyCard}>
            <h3>🌍 Deploy Anywhere</h3>
            <p>
              One configuration, multiple destinations. Deploy to AWS, Azure, GCP, 
              on-premises, or edge devices without changing your code.
            </p>
          </div>
          <div className={styles.whyCard}>
            <h3>🔧 Config-Based</h3>
