...
class TestCSVParser(unittest.TestCase):
    ...
    def setUp(self):
        ...
        fieldnames = ["subject", "body", "answer", "type", "queue", "priority", "language", "tag_1", "tag_2"]
    ...
    def test_custom_config(self):
        ...
        self.assertNotIn("Reset your password", doc.content)  # Answer should not be in content
...
class TestOllamaEmbedder(unittest.TestCase):
    ...
    def test_embedding_generation(self):
        ...
        self.assertTrue(all(isinstance(emb, list) and len(emb) > 0 for emb in embeddings))
